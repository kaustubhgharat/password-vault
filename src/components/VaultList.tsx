...
export default function VaultList() {
  ...
  const handleExport = () => {
    ...
    if (
      !window.confirm(
        "This will export all your vault items to an encrypted text file. Continue?"
      )
    )
      return;
    ...
    a.href = url;
    a.download = `secure-vault-backup-${
  ...
  const handleImport = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = async (e) => {
      ...
      try {
        ...
        toast.loading(`Importing ${importedItems.length} items...`, {
          id: "import-toast",
        });
        ...
        toast.error(
          "Import failed. The file may be corrupt or the decryption key is incorrect."
        );
      }
    };
      ...
      <div className="flex flex-col gap-4 mb-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600 dark:hover:bg-gray-600"
          >
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-blue-600 rounded-md hover:bg-blue-700"
          >
            ...
            >
                  ...
                  {item.tags && item.tags.length > 0 && (
                    <div className="flex flex-wrap gap-2 mt-2">
                      {item.tags.map((tag) => (
                        <span
                          key={tag}
                          className="px-2 py-1 text-xs font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300"
                        >
                          {tag}
                        </span>
                      ))}
              ...
              <div className="flex items-center justify-between mt-2">
                ...
                <button
                  ...
                  className="flex items-center gap-1 px-2 py-1 text-xs text-blue-600 rounded-md hover:bg-blue-50 dark:hover:bg-gray-700"
                >
